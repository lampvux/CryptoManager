...
try {
    $addressBalance = $addressClient->getBalance('1BoatSLRHtKNngkdXEeobR76b53LETtpyT');
} catch (Exception $ex) {
    ResultPrinter::printError("Get Only Address Balance", "Address Balance", '1BoatSLRHtKNngkdXEeobR76b53LETtpyT', null, $ex);
    exit(1);
}
